...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        CursorLineNr { fg = hsl(250, 250, 250), gui = "bold" },                          -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
        MatchParen { gui = "bold, underline, italic", fg = purple.da(30), bg = purple }, -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
        ...
        PmenuSel { fg = hsl(180, 70, 50), bg = Normal.fg.da(70) },                       -- Popup menu: Selected item.
        ...
        Identifier { fg = purple },                          -- (*) Any variable name
        ...
        Exception { fg = hsl(160, 60, 60) },                 --   try, catch, throw
        ...
        Special { gui = "italic", fg = hsl(60, 60, 50), },   -- (*) Any special symbol
        ...
        DiagnosticWarn { fg = hsl(30, 100, 50) },       -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticInfo { fg = hsl(180, 100, 50) },      -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticHint { fg = hsl(160, 50, 50) },       -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        ...
        sym "@tag" { Tag },                       -- Tag
        sym "@markup.heading.2.markdown" { fg = purple.da(60), bg = purple },
        sym "@punctuation.special.markdown" { fg = purple.da(60), bg = purple },

...
vim.keymap.set("n", "<leader>d'", "dt'", { desc = "Delete till '" })
vim.keymap.set("n", '<leader>d"', 'dt"', { desc = 'Delete till "' })
vim.keymap.set("n", "<leader>d<space>", "dt ", { desc = "Delete till <space>" })
vim.keymap.set("n", "<leader><leader>d;", "df;", { desc = "Delete find ;" })
vim.keymap.set("n", "<leader><leader>d,", "df,", { desc = "Delete find ," })
vim.keymap.set("n", "<leader><leader>d'", "df'", { desc = "Delete find '" })
vim.keymap.set("n", '<leader><leader>d"', 'df"', { desc = 'Delete find "' })
vim.keymap.set("n", "<leader><leader>d<space>", "df ", { desc = "Delete find <space>" })

vim.keymap.set("n", "<leader>c;", "ct;", { desc = "Change till ;" })
vim.keymap.set("n", "<leader>c,", "ct,", { desc = "Change till ," })
vim.keymap.set("n", "<leader>c'", "ct'", { desc = "Change till '" })
vim.keymap.set("n", '<leader>c"', 'ct"', { desc = 'Change till "' })
vim.keymap.set("n", "<leader>c<space>", "dc ", { desc = "Change till <space>" })
vim.keymap.set("n", "<leader><leader>c;", "cf;", { desc = "Change find ;" })
vim.keymap.set("n", "<leader><leader>c,", "cf,", { desc = "Change find ," })
vim.keymap.set("n", "<leader><leader>c'", "cf'", { desc = "Change find '" })
vim.keymap.set("n", '<leader><leader>c"', 'cf"', { desc = 'Change find "' })
vim.keymap.set("n", "<leader><leader>c<space>", "cf ", { desc = "Change find <space>" })

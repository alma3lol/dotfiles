...
nnoremap <leader>rs :RenameState<CR>
...
nnoremap <leader>1 :BufferLineCyclePrev<CR>
nnoremap <leader>2 :BufferLineCycleNext<CR>
...
nnoremap <leader>fwh :h <C-R>=expand("<cword>")<CR><CR>
...
nnoremap <leader><leader>w :Telescope workspaces<CR>
...
nnoremap <leader>pp :Telescope command_palette<CR>
nnoremap <leader>os <cmd>lua require("luasnip.loaders").edit_snippet_files()<CR>
...
nnoremap <silent> ,B :lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>
nnoremap <silent> ,Bl :lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>
...
nnoremap <leader>cja :call CreateJupyterAscendingNotebook()<CR>
